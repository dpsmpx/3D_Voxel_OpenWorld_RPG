...
> покрыта 176 автоматическими проверками (`tools/hostcheck/run.sh`).
...
Три инструмента работают на обычном Linux-хосте, без Android-устройства
...
```bash
./tools/hostcheck/run.sh      # компиляция, линковка, шейдеры, 176 проверок
