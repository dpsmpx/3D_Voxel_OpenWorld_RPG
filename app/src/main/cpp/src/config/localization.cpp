...
static const char* EN[STR_KEY_COUNT] = {
    ...
    /* Menu_Play */         "PLAY",
    /* Menu_GameTitle */    "VOXEL RPG",
    /* Menu_GroupCharacter */ "CHARACTER",
    /* Menu_GroupWorld */   "WORLD",
    /* Menu_GroupSystem */  "GAME",
    ...
    /* Iso_Title */         "ISOMETRIC WORLD MAP",
    /* Iso_Open */          "Isometric world map",
    /* Iso_Size */          "Area size",
    /* Iso_View */          "Viewing side",
    /* Iso_Preview */       "Preview",
    /* Iso_Done */          "Done",
    /* Iso_North */         "North",
    /* Iso_East */          "East",
    ...
    /* Iso_West */          "West",
    /* Iso_Center */        "Centre",
    /* Iso_Preparing */     "Preparing terrain...",
    /* Iso_Rendering */     "Rendering map...",
    /* Iso_Saving */        "Saving...",
    /* Iso_Saved */         "Map saved",
    /* Iso_PreviewWait */   "Preview is being prepared",
    /* Iso_ErrMemory */     "Not enough memory",
    /* Iso_ErrGeneration */ "World did not finish generating",
    /* Iso_ErrTarget */     "Render target error",
    /* Iso_ErrSave */       "Could not save the file",
...
static const char* RU[STR_KEY_COUNT] = {
    ...
    /* Menu_Trade */        "ТОРГОВЛЯ",
    /* Menu_Worlds */       "МИРЫ",
    /* Menu_MainMenu */     "В МЕНЮ",
    /* Menu_Play */         "ИГРАТЬ",
    /* Menu_GameTitle */    "VOXEL RPG",
    /* Menu_GroupCharacter */ "ПЕРСОНАЖ",
    /* Menu_GroupWorld */   "МИР",
    /* Menu_GroupSystem */  "ИГРА",
    ...
    /* Iso_Title */         "ИЗОМЕТРИЧЕСКИЙ СНИМОК МИРА",
    /* Iso_Open */          "Изометрический снимок мира",
    /* Iso_Size */          "Размер области",
    /* Iso_View */          "Сторона обзора",
    /* Iso_Preview */       "Предпросмотр",
    /* Iso_Done */          "Готово",
    /* Iso_North */         "Север",
    /* Iso_East */          "Восток",
    /* Iso_South */         "Юг",
    /* Iso_West */          "Запад",
    /* Iso_Center */        "Центр",
    /* Iso_Preparing */     "Подготавливаем территорию...",
    /* Iso_Rendering */     "Рендер карты...",
    /* Iso_Saving */        "Сохранение...",
    /* Iso_Saved */         "Карта сохранена",
    /* Iso_PreviewWait */   "Предпросмотр готовится",
    /* Iso_ErrMemory */     "Не хватило памяти",
    /* Iso_ErrGeneration */ "Мир не догенерировался",
    /* Iso_ErrTarget */     "Ошибка цели рендера",
    /* Iso_ErrSave */       "Не удалось сохранить файл",
