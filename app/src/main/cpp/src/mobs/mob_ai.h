...
/// Откат твари между ударами, секунды: от попадания до начала
/// следующего замаха. Полный такт удара — откат плюс замах
/// (MobDef::windupTime); по нему и считается, насколько тварь опасна.
constexpr f32 MOB_ATTACK_COOLDOWN = 1.2f;
