...
/// Годится ли опора под ступнями для рождения (см. world::Footing):
/// земля — да; постройка — только под крышей; ствол, кактус, листва
/// и пустота под серединой тела — нет.
...
/// годной опоре (spawnFooting). Если на месте такой нет — та же
/// попытка в соседних клетках, до двух блоков в сторону. Возвращает
/// false, если места нет нигде.
///
...
/// пока он не оказывался на крыше. Подъём из толщи тоже приводил
/// наверх: точка в стене дома выходила на кровлю, точка у ствола —
/// на его верх под кроной.
