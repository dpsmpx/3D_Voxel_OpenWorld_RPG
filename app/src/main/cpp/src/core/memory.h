...
// ============================================================
// Arena Ч bump-аллокатор блоками по 1 ћЅ.
// »деально дл€ per-frame данных, временных буферов генерации.
// reset() не освобождает пам€ть, а переиспользует блоки.
// ============================================================
class Arena {
public:
    ...
    // –азрешаем перемещение дл€ работы std::swap
    ...
    // —брос Ч переходим к первому блоку, offset = 0
...
// ============================================================
// Pool<T> Ч фиксированный пул объектов с free-list.
// ƒл€ сущностей, мобов, снар€дов Ч слоты переиспользуютс€.
// ============================================================
template<typename T>
class Pool {
public:
...
// ============================================================
// FrameAllocator Ч двойной буфер: current/previous.
// ¬сЄ, что аллоцировано в этом кадре, живЄт до конца следующего.
// ============================================================
