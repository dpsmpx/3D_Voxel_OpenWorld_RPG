...
public:
    ...
    /// узком экране до них докручивают (`UiSystem::invScroll`, та же
    /// `ui::Scroll`, что у ремесла и журнала), а не отнимают место у
    /// ячеек. Отнять пробовал: сумка тогда теряла все двадцать семь.
