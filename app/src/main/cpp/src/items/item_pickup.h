...
struct ItemPickup {
    ...
    /// заросло бы мусором. Узелок, оставшийся на месте гибели, —
    /// другое дело: погибший в дальнем логове за пять минут не
    /// успеет и полпути. Он ждёт столько, сколько нужно.
    bool      waits = false;
};
