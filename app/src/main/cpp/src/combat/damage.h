...
struct DamageInstance {
    ...
    /// Сила горения, урон/с. Ноль — десятая доля удара, как было
    /// всегда. Струе огня этого мало: её удар дробится на частые
    /// тики по полтора урона, и десятая доля такого тика — это
    /// пламя, которое не жжёт.
    f32 burnDps      = 0.f;
