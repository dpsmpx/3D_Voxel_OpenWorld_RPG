 ...
 */
#pragma once
// Save format v11: world generation changed (hydrology rivers); deltas unchanged.
...
///   8..10 — подобранное золото и постоянные ключи раздатчиков
///       заданий.
///   11 — состав файла прежний, мир — нет, как и в седьмой: реки
///       стали гидросетью с озёрами, долинами и дельтами, и у того
///       же зерна другая земля вдоль воды. Правки игрока старого
///       файла легли бы на неё мимо. Заодно правка, вернувшая клетку
///       к сгенерированному, больше не пишется вовсе.
///   12 — побеждённые боссы (после вскрытых тайников). Заодно мир
///       снова другой: рельеф по масштабам и растения записями.
///
/// Загрузчик отвергает файлы другой версии: лучше честно сказать
/// «не поддерживается», чем прочитать данные со сдвигом.
constexpr u32 SAVE_VERSION = 12;
