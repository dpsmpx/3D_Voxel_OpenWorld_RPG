...
/// Сколько секунд без урона, прежде чем здоровье начнёт отрастать.
///
/// Отрастание шло всегда, и посреди драки тоже: полтора в секунду
/// против двух с половиной от волка — и первый же зверь убивал
/// стоящего столбом игрока больше минуты. Бой должен решаться боем,
/// а лечиться посреди него — зельем и едой, а не ожиданием.
constexpr f32 HEALTH_REGEN_DELAY = 6.f;
