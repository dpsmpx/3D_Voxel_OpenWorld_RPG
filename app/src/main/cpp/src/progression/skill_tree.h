...
/// Древо Познания. Три ветки: по 8 узлов у Силы и Ловкости, 10 у
/// Мудрости — два из них заклинания.
...
enum class SkillNodeId : u16 {
    ...
    // Заклинания. Номера — в конце: ранги в сохранении лежат по
    // номеру узла, и вставка в середину сдвинула бы чужие ранги.
    Wis_IceNeedles,      // ледяные иглы из маны; ранг — игл в залпе
    Wis_Flame,           // струя огня; ранг — длина и жар
...
struct SkillNodeDef {
    ...
    u8           position;     // позиция в ветке (для UI)
};
