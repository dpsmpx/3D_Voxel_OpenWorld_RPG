...
int main(int argc, char** argv) {
    ...
    jobs::gJobs.start(4);
    {
        // Радиус 3 чанка — чтобы вокруг точки замера лежал настоящий
        // мир, а не пустота. Иначе чтения уходят по короткому пути
        // «чанка нет», и замер покажет не ту работу, что в игре.
