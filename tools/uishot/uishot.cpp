...
int main(int argc, char** argv) {
    ...
    // Задания кладутся и для чистого HUD: строка текущей цели берёт
    // их из того же журнала, и без них ей нечего показать — ровно
    // то, что видел игрок в первые минуты.
    if (o.screen == ui::Screen::QuestLog || o.questCount > 1 ||
        o.screen == ui::Screen::Hud) {
